...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function() {
	    ...
	    React.render(React.createElement(DatePicker, {date:  new Date() }), demo1);
	    React.render(React.createElement(DatePicker, {date:  new Date(), unavailableAfter:  new Date() }), demo2);
	    React.render(React.createElement(DatePicker, {date:  new Date(), unavailableBefore:  new Date() }), demo3);
	    React.render(React.createElement(DatePicker, {date:  new Date(), changeSelectedDate:  changeDate, showToday:  true }), demo4);
	    React.render(React.createElement(DatePicker, {date:  new Date(), changeSelectedDate:  changeDate, showToday:  true, showHoliday:  true }), demo5);
	    React.render(React.createElement(DatePicker, {date:  new Date(), disabled:  true }), demo6);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatePicker = React.createClass({displayName: "DatePicker",
	    ...
	    render: function() {
	        ...
	        return (
	            React.createElement("div", {id: "datepicker-wrapper"}, 
	                React.createElement("span", {onClick:  this.showCalendar, className:  spanClassName },  this.state.selectedDate), 
	                React.createElement(Calendar, {show:  this.state.show, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    render : function() {
	        ...
	        return (React.createElement("div", {className: "pms-calendar", id: "react-calendar", style:  style, tabIndex:  0, onBlur:  this.props.hideCalendar}, 
	                 React.createElement("div", {className: "calendar-wrapper"}, 
	                   React.createElement("div", {className: "calendar-month"}, 
	                     React.createElement("div", {className: "calendar-month-title"},  calendarTitle ), 
	                      React.createElement("span", {className: "cal-month-nav nav-prev", onClick:  this.handlePrev}, "<"), 
	                      React.createElement("span", {className: "cal-month-nav nav-next", onClick:  this.handleNext}, ">"), 
	                      React.createElement("table", {dangerouslySetInnerHTML: { __html:calendarHTML}, onClick:  this.handleSelectDate})
	                   )
	                 )
	               ));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./calendar-style.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./calendar-style.css");
